...
class Container extends React.Component {
    ...
    //HIDES VILLAINS WHEN PAGE LOADS
    toggleHidden() {
        this.setState({
            isHidden: !this.state.isHidden
        })
    }
    //VILLAINS APPEAR / START BUTTON
    showMonster() {
    ...
    render() {
        return (
            <div>
                <Header />
                <button onClick={this.showMonster.bind(this)} id= 'start'> Start Game</button>
                ...
                <h3 id="shopHeader"> <span className="badge badge-primary">Item Shop </span> </h3>
